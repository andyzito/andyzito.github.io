...
An Obsidian plugin that automatically detects key combos and wraps them in `<kbd>` tags, like this:

<kbd>⌘</kbd> + <kbd>A</kbd>.

It also provides a new Markdown syntax for manually forcing a `<kbd>` tag: `«CMD»` becomes <kbd>CMD</kbd>.
